        ...
        <section class="prestasi-akademik">
            ...
            <div class="achievements-container">
                <div class="achievement">
                    <img src="./img/akademik1.png" alt="Yustira Fatimah" class="resized-image">
                </div>
                
                <div class="achievement">
                    <img src="./img/akademik2.png" alt="Valenia Vieya Wijaya" class="resized-image">
                </div>
                
                <div class="achievement">
                    <img src="./img/akademik3.png" alt="A'zahro Zifahusma'ani" class="resized-image">
                </div>
                
                <div class="achievement">
                    <img src="./img/akademik4.png" alt="Benaca Almeera" class="resized-image">
                </div>
                
                <div class="achievement">
                    <img src="./img/akademik5.png" alt="Dzakirah Thalita" class="resized-image">
                </div>
            </div>
        </section>
